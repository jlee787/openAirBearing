...
def register_callbacks(app):
    ...
    def update_bearing(case, solvers, pa_mpa, ps_mpa, pc_mpa, rho, mu, hp_mm, xa_mm, xc_mm, nx, ya_mm, ny, 
                  ha_min_um, ha_max_um, nh, kappa, Qsc, error_type, error_um, Psi):
        ...
        try:
            ...
            return (plot_key_results(b, results),
    ...
    def toggle_containers(case):
        ...
        match case:
            case 'annular':
                return {**base_style, 'display': 'grid'}, {**base_style, 'display': 'grid'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}
            case 'infinite':
                return {**base_style, 'display': 'grid'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}
            case 'rectangular':
                return {**base_style, 'display': 'grid'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'grid'}, {**base_style, 'display': 'grid'}
            case _:        
                return {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}, {**base_style, 'display': 'none'}
    ...
    def reset_values(reset_all, *args):
        ...
        return [
            ...
            for p in ['rho', 'mu', 'hp','xa', 'xc', 'ya', 'kappa', 'Qsc', 
                      'pa', 'pc', 'ps', 'ha_min', 'ha_max', 'nx', 'ny', 'nh', 'error', 'psi']
        ]
